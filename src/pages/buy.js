    ...
    <div className="h-full w-full flex justify-center pt-10">
      ...
      >
        ...
        <div className="flex flex-col mt-10">
          <div className="text-2xl text-[#2A3033] font-semibold">Buy AAPL</div>
